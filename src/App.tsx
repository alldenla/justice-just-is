...
export default function App() {
  ...
  const servicesWithPanel: ServiceType[] = [
    ...
    'MAXWELL_CHAMBERS', 'BISHAN_MARYMOUNT_CC', 'BUKIT_BATOK_EAST_CC',
    'EUNOS_CC', 'FERNVALE_LEGAL_ADVICE', 'GEYLANG_WEST_CC',
    'HENDERSON_CC', 'HWI_YOH_CC', 'JOO_CHIAT_CC', 'JURONG_SPRING_CC',
    'KAMPONG_KEMBANGAN_CC', 'KEBUN_BAHRU_LINK_RC', 'KIM_SENG_CC',
    'KRETA_AYER_CC', 'MARINE_PARADE_CC', 'NEE_SOON_EAST_CC',
    'PASIR_RIS_ELIAS_CC', 'POTONG_PASIR_CC', 'QUEENSTOWN_CC',
    'RADIN_MAS_CC', 'RIVERVALE_CC', 'SENGKANG_CC', 'SIGLAP_CC',
    'TAMPINES_CENTRAL_CC', 'TAMPINES_CHANGKAT_CC', 'TAMPINES_NORTH_CC',
    'TANJONG_PAGAR_CC', 'THE_FRONTIER_CC', 'ULU_PANDAN_CC',
    'WHAMPOA_CC', 'ZHENGHUA_CC'
  ];
